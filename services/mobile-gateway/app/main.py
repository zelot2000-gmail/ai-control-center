...
_WORKFLOW_MAP = {
    ...
    # self-modify code workflow — caller can use these keywords to route
    "self-modify": "self-modify-workflow",
    "แก้โค้ด": "self-modify-workflow",
    "ปรับโค้ด": "self-modify-workflow",
    "refactor": "self-modify-workflow",
    "แก้หน้า": "self-modify-workflow",
    "ปรับหน้า": "self-modify-workflow",
    "แก้ bug": "self-modify-workflow",
    "fix bug": "self-modify-workflow",
    "เพิ่ม endpoint": "self-modify-workflow",
